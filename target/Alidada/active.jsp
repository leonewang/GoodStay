        ...
        <div class="login-screen" style="padding: 123px 199px 33px 306px !important;">
            ...
            <form role="form">
                ...
                <div class="login-form">
                    ...
                    <small class="activate">Your account has been activated successfully!</small>
                    <small class="activate">Click the button below to login</small>
