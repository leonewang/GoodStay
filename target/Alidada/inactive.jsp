...
<head>
    ...
    <title>Inactive | UNSW BOOK</title>
    <!-- Bootstrap core CSS -->
        ...
        <div class="login-screen" style="padding: 123px 199px 33px 306px !important;">
            ...
            <form role="form">
                ...
                <div class="login-form">
                    <span class="fui-check-circle" style="color: #E74C3C;"> Great!</span>
                    <small class="activate">An activate email has been sent!</small>
                    <small class="activate">Please check your email address!</small>
                    <a class="btn btn-primary btn-lg btn-block" href="signin.jsp">Go to Signin</a>
                </div>
            </form>
        </div>
    </div>
