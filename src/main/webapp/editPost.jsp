...
<div class="gs-container container">
    ...
    <div class="gs-content">
        <div>
            <h4 style="margin:0 0 30px 0;">Update info
                <a id="delete-post" class="btn btn-sm btn-danger" style="margin-left: 20px;"><span class="fui-trash"></span> Delete post</a>
            </h4>
        </div>
        <div class="gs-content-left">
            <div class="list-form">
                <form action="/EditPostServlet" method="post">
                    ...
                    <input type="text" name="postID" value="<%=post.getId()%>" id="post_id" hidden/>
                    <div id="list-title">
                        <div class="list-text">
                            <strong>Title</strong> <span class="gs-color-dsun">*</span>
                        </div>
                        <div class="list-input">
                            <input type="text" class="form-control" value="<%=post.getTitle()%>" name="title" placeholder="Within 100 characters ..." />
                        </div>
                    </div>
                    ...
                    <div id="list-address">
                        ...
                        <div class="list-input">
                            <input id="pac-input" type="text" class="form-control" value="<%=post.getAddress()%>" name="address" onFocus="geolocate()"
                                   placeholder="e.g. 3/17 Mascot Drive, Eastlakes NSW" onkeydown="if(event.keyCode==13){return false;}"/>
                        </div>
                    </div>

                    <div style="display: none;">
                        <input type="text" value="<%=post.getPlaceid()%>" name="placeid" id="placeid"/>
                        <input type="text" value="<%=post.getCoordinate()%>" name="coordinate" id="coordinate"/>
                    </div>
                    ...
                    <div id="list-area">
                        ...
                        <div class="list-input">
                            <input id="locality" type="text" class="form-control" value="<%=post.getCity()%>" name="city" placeholder="e.g. Mascot"/>
                        </div>
                    </div>
                    ...
                    <div id="list-description">
                        ...
                        <div class="list-input">
                            <textarea class="form-control" rows="5" name="description" placeholder="Within 1000 characters ..."><%=post.getDescription()%></textarea>
                        </div>
                    </div>
                    ...
                    <div id="list-cash">
                        ...
                        <div class="list-input">
                            <input type="text" class="form-control input-sm list-input" value="<%=post.getPrice()%>" name="price" /> &nbsp;&nbsp;<small>AUD$ / night</small>
                        </div>
                    </div>
                    ...
                    <div id="list-bargain">
                        ...
                        <div class="list-input">
                            <%
                                if (post.getAlidadamatch().equals("false")) {
                            %>
                            <label class="radio">
                            ...
                            %>
                            <label class="radio">
                                <input type="radio" name="alidadamatch" value="true" data-toggle="radio" checked="">
                                Yes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </label>
                            <label class="radio">
                                <input type="radio" name="alidadamatch" value="false" data-toggle="radio">
                                No
                            </label>
                            <%
                                }
                    ...
                    <div id="list-time">
                        ...
                        <div class="input-daterange input-group list-input" id="datepicker">
                            <input type="text" class="input-sm form-control" value="<%=post.getStart_date()%>" name="start_date" />
                            <span class="input-group-addon input-sm">to</span>
                            <input type="text" class="input-sm form-control" value="<%=post.getEnd_date()%>" name="end_date" />
                        </div>
                    </div>
                    ...
                    <div id="list-submit">
                        <button id="save-edit" type="submit" class="btn btn-primary btn-embossed btn-block">Save</button>
                    </div>
