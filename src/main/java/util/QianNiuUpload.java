...
public class QianNiuUpload {
    ...
    public static String ACCESS_KEY = "X7xx6YNO5_lOydg-2n0ATq5t-3nUCp9_KSZm5l6M";
    public static String SECRET_KEY = "csiw8xZfcibXGqVw2ODAdaAghrJGb6BcxUPSO6G7";
    //要上传的空间
    public static String bucketname = "goodstay";
    //上传到七牛后保存的文件名
